...
| Database schema v0.1 | 🟡 | `users`, `vaults`, `envies` + seed. Classification columns now in scope per ADR-001 — server-side modelling is the next `area:db` work. |
