# Root changelog archive — 2026-08-15 to 2026-08-16

> 11 entries dated 2026-08-15 to 2026-08-16, moved out of the active changelog on 2026-08-25 to stay well under the docs-hygiene-lint 40,000-char cap (was 31,131 / 40,000, 78%).
> **Nothing was deleted** — these are verbatim, and git history holds them regardless.
> The ADR-001 "retire E2EE" decision this block includes is durably recorded in [docs/decisions/ADR-001-server-side-classification-data.md](../decisions/ADR-001-server-side-classification-data.md), not here — that stays the source of truth for the decision itself.
> Active changelog: [../../CHANGELOG.md](../../CHANGELOG.md) · Earlier archive: [CHANGELOG-pre-2026-08-15.md](CHANGELOG-pre-2026-08-15.md)
