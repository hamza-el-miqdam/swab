# apps/api changelog archive — before 2026-08-15

> 5 entries dated before 2026-08-15, moved out of the active changelog on 2026-08-16 so it stays small enough to read in full.
...
> Active changelog: [../../apps/api/CHANGELOG.md](../../apps/api/CHANGELOG.md)
