# packages/db changelog archive — 2026-08-15 to 2026-08-18

> 10 entries dated 2026-08-15 to 2026-08-18, moved out of the active changelog to keep it under
> the docs-hygiene-lint `MAX_CHANGELOG_CHARS` cap. **Nothing was deleted** — these are verbatim,
> and git history holds them regardless.
> This is a separate slice from [db-CHANGELOG-pre-2026-08-15.md](db-CHANGELOG-pre-2026-08-15.md), which covers entries before 2026-08-15 and is untouched by this move.
