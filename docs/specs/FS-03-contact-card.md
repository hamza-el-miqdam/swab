...
| ID | Requirement |
|---|---|
| FCH-01 | The four axes render as tap-editable controls; every edit writes to the vault immediately (optimistic, offline-capable) and appends a history event locally. Intimité's control offers the ring enumeration per ONB-04. |
