...
| ENV-04 | Every default exclusion is revocable in place (« Tu peux réintégrer qui tu veux ») — except veto absolu (FLT-02), which appears nowhere in the review (FLT-02). |
