...
**Layout (reorganised 2026-08-16):** implemented suggestions move to `done/<area>/`; `<area>/` holds only what is still open. Nothing is ever deleted — a completed suggestion stays as the audit record of why the change was made. **77 done, 37 open.** Links throughout this file point at wherever the file now lives.
...
|---|---|---|---|
| iOS | [10](ios/) | [8](done/ios/) | ios-specialist |
| Android | [5](android/) | [13](done/android/) | android-specialist |
...
- **Undecryptable vault = silent data loss (iOS) or crash loop (Android)** ([SUG-IOS-004](ios/SUG-IOS-004-undecryptable-vault-silently-empty.md), [SUG-AND-004](done/android/SUG-AND-004-vault-decrypt-failure-crashes-app.md)).
...
| 011 | [Vault persists French display strings as classification values](done/ios/SUG-IOS-011-classification-values-coupled-to-french-copy.md) | architecture | medium |
