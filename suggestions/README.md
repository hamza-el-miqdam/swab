...
**Layout (reorganised 2026-08-16):** implemented suggestions move to `done/<area>/`; `<area>/` holds only what is still open. Nothing is ever deleted — a completed suggestion stays as the audit record of why the change was made. **85 done, 31 open.** Links throughout this file point at wherever the file now lives.
...
|---|---|---|---|
| iOS | [6](ios/) | [12](done/ios/) | ios-specialist |
